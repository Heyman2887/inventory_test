...
#region Onclick
    ...
    public static void OnClickSpecialHandler()
    {
        ...
        {
            Debug.Log("使用了怀表");
            MouseManager.OnClickMouse += OnClickMouse;
        }
    }
    ...
    public static void DoesBagHaveSpecialItem()
    {
        ...
        if (item != null)
        {
            ...
            instance.specialButton.transform.GetChild(0).GetComponent<Text>().color = new Color(0, 0, 0, 0);
        }
    }
    ...
    public static void OnClickMouse(GameObject gameObject)
    {
